...
const MISIONES = [
  { id:'m01', name:'Meditación',            desc:'Mínimo 10 minutos',         xp:10, coins:1, hidden:false, freq:'Diario', dif:2, img:'assets/Avatar_Rango_E_meditacion.png',
    cats:[{cat:'presencia',stars:3},{cat:'mente',stars:2},{cat:'enfoque',stars:1}] },
  { id:'m02', name:'Oración / Gratitud',    desc:'5 a 10 minutos',            xp:10, coins:1, hidden:false, freq:'Diario', dif:1, img:'assets/Avatar_Rango_E_oracion_y_gratitud.png',
    cats:[{cat:'presencia',stars:3},{cat:'vinculo',stars:2}] },
  { id:'m03', name:'Levantar Pesas',        desc:'Mínimo 45 minutos',         xp:20, coins:2, hidden:false, freq:'3x/sem', dif:4, img:'assets/Avatar_Rango_E_levantar_pesas.png',
    cats:[{cat:'cuerpo',stars:3},{cat:'enfoque',stars:2}] },
  { id:'m04', name:'Correr',                desc:'Mínimo 30 minutos',         xp:15, coins:2, hidden:false, freq:'3x/sem', dif:3, img:'assets/Avatar_Rango_E_correr.png',
    cats:[{cat:'cuerpo',stars:3},{cat:'enfoque',stars:2},{cat:'presencia',stars:1}] },
  { id:'m05', name:'Hidratación',           desc:'2 a 3 litros de agua',      xp:8,  coins:1, hidden:false, freq:'Diario', dif:1, img:'assets/Avatar_Rango_E_hidratacion.png',
    cats:[{cat:'cuerpo',stars:2}] },
  { id:'m06', name:'Nutrición',             desc:'Alimentación limpia',       xp:8,  coins:1, hidden:false, freq:'Diario', dif:2, img:'assets/Avatar_Rango_E_nutricion.png',
    cats:[{cat:'cuerpo',stars:2},{cat:'presencia',stars:1}] },
  { id:'m07', name:'Dormir 7–8h',           desc:'Sueño completo y reparador',xp:10, coins:1, hidden:false, freq:'Diario', dif:2, img:'assets/Avatar_Rango_E_Dormir_7_o_8_H.png',
    cats:[{cat:'cuerpo',stars:3},{cat:'mente',stars:2}] },
  { id:'m08', name:'Afirmaciones',          desc:'5 a 10 minutos',            xp:8,  coins:1, hidden:false, freq:'Diario', dif:1, img:'assets/Avatar_Rango_E_Afirmaciones.png',
    cats:[{cat:'mente',stars:3},{cat:'enfoque',stars:2},{cat:'presencia',stars:1}] },
  { id:'m09', name:'Lectura',               desc:'Mínimo 5 páginas',          xp:12, coins:1, hidden:false, freq:'Diario', dif:2, img:'assets/Avatar_Rango_E_lectura.png',
    cats:[{cat:'mente',stars:3},{cat:'enfoque',stars:2}] },
  { id:'m10', name:'Journal',               desc:'Escribir reflexiones del día',xp:8, coins:1, hidden:false, freq:'Diario', dif:2, img:'assets/Avatar_Rango_E_journal.png',
    cats:[{cat:'mente',stars:3},{cat:'presencia',stars:2}] },

  { id:'m11', name:'Caminar',               desc:'Mínimo 20 minutos al aire libre',xp:10, coins:1, hidden:true, freq:'Diario', dif:1,
    cats:[{cat:'cuerpo',stars:3},{cat:'presencia',stars:1}] },
  { id:'m12', name:'Ciclismo',              desc:'Mínimo 30 minutos',            xp:15, coins:2, hidden:true, freq:'2x/sem', dif:3,
    cats:[{cat:'cuerpo',stars:3},{cat:'enfoque',stars:1}] },
  { id:'m13', name:'Socializar',            desc:'Conversación real y profunda',  xp:8,  coins:1, hidden:true, freq:'1x/sem', dif:3,
    cats:[{cat:'vinculo',stars:3},{cat:'presencia',stars:1}] },
  { id:'m14', name:'Estiramiento',          desc:'10 a 20 minutos',              xp:8,  coins:1, hidden:true, freq:'Diario', dif:1,
    cats:[{cat:'cuerpo',stars:2},{cat:'presencia',stars:1}] },
  { id:'m15', name:'Levantarse Temprano',   desc:'Antes de las 6am',             xp:10, coins:1, hidden:true, freq:'Diario', dif:4,
    cats:[{cat:'enfoque',stars:3},{cat:'cuerpo',stars:1}] },
  { id:'m16', name:'Ducha Fría',            desc:'Al menos 2 minutos fría',      xp:10, coins:1, hidden:true, freq:'Diario', dif:4,
    cats:[{cat:'enfoque',stars:3},{cat:'cuerpo',stars:2}] },
  { id:'m17', name:'Luz Solar',             desc:'10 minutos directos de sol',   xp:8,  coins:1, hidden:true, freq:'Diario', dif:1,
    cats:[{cat:'cuerpo',stars:2},{cat:'presencia',stars:1}] },
  { id:'m18', name:'Higiene',               desc:'Rutina completa de aseo',      xp:5,  coins:1, hidden:true, freq:'Diario', dif:1,
    cats:[{cat:'cuerpo',stars:1}] },
  { id:'m19', name:'Ordenar Entorno',       desc:'Espacio limpio y organizado',  xp:8,  coins:1, hidden:true, freq:'Diario', dif:2,
    cats:[{cat:'enfoque',stars:2},{cat:'presencia',stars:1}] },
  { id:'m20', name:'Planificar el Día Sig.',desc:'Revisar y preparar el mañana', xp:10, coins:1, hidden:true, freq:'Diario', dif:1,
